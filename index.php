...
<Border Padding="12" Background="{DynamicResource ColorBrush4}" CornerRadius="3,3,0,0" Margin="0,0,0,0" BorderThickness="3,0,0,0" BorderBrush="{DynamicResource ColorBrush3}">
...
<local:MyHint Theme="Blue" Text="欢迎来到新 MKSS！" CornerRadius="0,0,3,3" Margin="0,0,0,15"/>
